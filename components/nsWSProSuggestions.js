 ...
 *   Martijn Kooij <extensions@captaincaveman.nl> (Modified for use in WSPro)
 *
...
const BROWSER_SUGGEST_PREF = "extensions.mmsearch.mmsearch-googlesuggest";
const XPCOM_SHUTDOWN_TOPIC              = "xpcom-shutdown";
const NS_PREFBRANCH_PREFCHANGE_TOPIC_ID = "nsPref:changed";
const SEARCH_BUNDLE = "chrome://websearchpro/locale/websearchpro.properties";
...
if (typeof(JSON) != "object") Cu.import("resource://gre/modules/JSON.jsm");
...
SuggestAutoCompleteResult.prototype = {
  ...
  /*Implemented getLabelAt, this was throwing errors in Ff4b7, might get resolved later?*/
...
SuggestAutoComplete.prototype = {
  ...
  onReadyStateChange: function() {
    ...
    var serverResults = "";
    if (typeof(JSON.parse) != "function") serverResults = JSON.fromString(responseText);
    else serverResults = JSON.parse(responseText);
	...
	{
		try {comments[0] = this._strings.GetStringFromName("wspro-suggestions-label");}
		catch (e) {comments[0] = "Suggestions";}
	}
  ...
  startSearch: function(searchString, searchParam, previousResult, listener) {
	...
	//Captain Caveman 
    //Changed so the current engine does not have to support suggestions, just search for the default google engine supporting Google Suggest.
...
SearchSuggestAutoComplete.prototype = {
  classDescription: "Web Search Pro Remote Search Suggestions",
  contractID: "@mozilla.org/autocomplete/search;1?name=wspro-remote-url-suggestions",
  classID: Components.ID("{8F8833CC-5568-4d90-9157-5B816F893347}"),
